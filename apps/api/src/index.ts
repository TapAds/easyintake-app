...
import { publicIntakeRouter } from "./api/routes/publicIntake";
import { formCatalogRouter } from "./api/routes/formCatalog";
...
app.use("/api/intake/form-catalog", formCatalogRouter);
app.use("/api/onboarding/state", onboardingRouter);
